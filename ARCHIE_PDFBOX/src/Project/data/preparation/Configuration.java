...
public class Configuration {
    ...
    public static final String XML_PATH = "K:/articles.A-B/";//E:/Doctoral_Research/Source/XML/";
    ...
    public static final String[] XML_ARTICLE_TRANS_TITLE = {"/article/front/article-meta/title-group//trans-title-group//*[text()]"};
...
//    public static final String[] XML_ARTICLE_BODY_FIG = {"article/body//sec//fig//descendant::*[text()] | article/body//sec//sec//fig//descendant::*[text()] | article/floats-group//fig//descendant::*[text()] | article/body//fig//descendant::*[text()]"};
    public static final String[] XML_ARTICLE_BODY_FIG = {"article/body//sec//fig[contains(@id, 'fig')]//label[text()] | article/body//sec//sec//fig[contains(@id, 'fig')]//label[text()] | article/floats-group//fig[contains(@id, 'fig')]//label[text()] | article/body//fig[contains(@id, 'fig')]//label[text()]"};
    public static final String[] XML_ARTICLE_BODY_FIG_CAPTION_TITLE = {"article/body//sec//fig[contains(@id, 'fig')]//caption//title[text()] | article/body//sec//sec//fig[contains(@id, 'fig')]//caption//title[text()] | article/floats-group//fig[contains(@id, 'fig')]//caption//title[text()] | article/body//fig[contains(@id, 'fig')]//caption//title[text()]"};
    public static final String[] XML_ARTICLE_BODY_FIG_CAPTION_PARA = {"article/body//sec//fig[contains(@id, 'fig')]//caption//p[text()] | article/body//sec//sec//fig[contains(@id, 'fig')]//caption//p[text()] | article/floats-group//fig[contains(@id, 'fig')]//caption//p[text()] | article/body//fig[contains(@id, 'fig')]//caption//p[text()]"};
...
//    public static final String[] XML_AUTHOR = {"article/front/article-meta/contrib-group//contrib[@contrib-type='author']/name/descendant-or-self::*[text()]"};
    ...
    public static final String ARTICLE__PUBLISH_YEAR_TBL = "Article_publish_year";
