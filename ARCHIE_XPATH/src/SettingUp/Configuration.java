...
public class Configuration {
    ...
    public static final String[] XML_ARTICLE_ABS = {"article/front/article-meta/abstract[1]//descendant::*[text()]"};
    ...
    public static final String[] XML_ARTICLE_PARAGRAPH = {"article/body//sec//descendant-or-self::p[text()]"};
   
    //public static final String[] XML_ARTICLE_PARAGRAPH_FIG = {"article/body//sec//p//xref[@ref-type='fig'][text()] | article/body//sec//p//xref[@ref-type='sec'][text()]"};
